    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          recycling_impact_kg: data.recycling_impact_kg?.toString() || ''
        });
      ...
      toast({
        title: "Error",
        description: "Failed to load event or you don't have permission to edit it",
        variant: "destructive",
      });
      navigate('/events');
    } finally {
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-lg text-gray-600">
            Update your ocean conservation event details
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update the details for your ocean conservation event
            </CardDescription>
          </CardHeader>
          <CardContent>
